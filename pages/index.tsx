...
export default function Home() {
  const postManagerContract = "0xc21f553C173Ad8d1ea8De9D39f137C6900945017"; //postManager smart contract address
    ...
    <>
      ...
      >
        <div className={styles.topPanel}>
          <div onClick={() => setPostToActive(null)} className={styles.goHome}>{`Forum dAPP`}</div>
            ...
            <>
              ...
              <div className={styles.createPostContainer}>
                ...
                <footer className={styles.footertext}>
                  Developed by  <Link href={`https://www.linkedin.com/in/shivsharan-patil-6435a1181/`}>@Shivsharan.</Link>
               </footer>
              </div>
